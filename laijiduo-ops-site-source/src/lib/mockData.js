export const storesSeed = [
  ...
  ["S05", "前鎮隆興店", "前鎮區", "威廷副店長", 72000, 22100, 26100, 31900, "approved", 200, "正常", "22:21"],
  ["S06", "鳳山南華店", "鳳山區", "五甲店統籌", 0, 0, 0, 0, "draft", null, "待回報", "尚未回報"],
...
export const storeHoursSeed = [
  ["鳳山五甲店", "10:00", "23:00", "11:30-13:30", "17:00-19:00", "7", "14:00", "19:00", "23:00"],
  ...
  ["鳳山南華店", "09:00", "21:00", "11:30-13:30", "17:00-19:00", "7", "14:00", "19:00", "21:00"],
...
export const staffRosterSeed = [
  ["鳳山五甲店", "店長", "阿暄"], ["鳳山五甲店", "正式人員", "穎德"], ["鳳山五甲店", "新進人員", "韋呈"], ["鳳山五甲店", "新進人員", "銘泉"], ["鳳山五甲店", "新進人員", "慶彰"], ["鳳山五甲店", "兼職人員", "欣樺", "09:00", "14:00"], ["鳳山五甲店", "兼職人員", "錡錡", "14:00", "21:00"], ["鳳山五甲店", "兼職後勤", "娟姨"], ["鳳山五甲店", "送貨人員", "彥璋"], ["鳳山五甲店", "兼職後勤", "斌媽"], ["鳳山五甲店", "兼職後勤", "晹晹"],
...
export const scheduleSeed = storeHoursSeed.flatMap((store, storeIndex) => {
  ...
  const isClosed = storesSeed.find((row) => row.name === store.storeName)?.is_active === false;
...
export const supervisorTaskSeed = [
  ...
  ["task-4", "營運人力追蹤", "鳳山南華店", "督導長", "中", "進行中", "南華已恢復營業", "持續確認每日七人需求與五甲支援安排"],
...
export const hqTaskSeed = [
  {
    ...
    evidence: "人員名單與可排班時段",
    action: "確認店長或副店長、正式人員與兼職支援缺口",
    note: "南華店已恢復營業，由五甲統籌排假與人力支援",
  },
  {
    id: "hq-task-2",
    title: "各店排休表月度覆核",
    ...
    evidence: "月排休表與連續上班天數",
    action: "檢查是否超過連續工作六日與每日最低人力",
    note: "",
  },
  {
    id: "hq-task-3",
...
export const hrChangeSeed = [
  ...
  ["hr-5", "鳳山南華人力", "鳳山南華店", "人力追蹤", "無", "店長 / 正式人員", "持續追蹤", "督導長", "依每日七人需求持續檢視缺口"],
].map((row) => ({
  id: row[0],
  employeeName: row[1],
  storeName: row[2],

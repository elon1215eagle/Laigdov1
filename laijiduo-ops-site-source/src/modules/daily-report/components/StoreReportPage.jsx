      ...
      <section className="phone-shell">
        ...
        {tab === "sales" ? (
          <div className="mobile-stack">
            ...
            <RevenueInput label="全日總營收" helper="打烊後的全日總額" value={form.full_day_revenue} onChange={(value) => setForm({ ...form, full_day_revenue: value })} />
            ...
            <RevenueInput label="現金差異" helper="沒有差異請填 0" value={form.cash_difference} onChange={(value) => setForm({ ...form, cash_difference: value })} />

...
insert into public.stores (store_code, name, area, manager_name, target_daily_revenue) values
  ('S01', '鳳山五甲店', '北區', '阿瑄店長', 68000),
  ('S02', '鳳山凱旋店', '北區', '阿斌店長', 62000),
  ('S03', '鳳山武廟店', '北區', '阿斌店長', 59000),
  ('S04', '鳳山中山店', '北區', '樂樂店長', 64000),
  ('S05', '前鎮隆興店', '桃竹區', '威廷代副店', 72000),
  ('S06', '鳳山南華店', '桃竹區', '阿瑄店長', 76000),
  ('S07', '三民鼎山店', '中區', '超哥店長', 53000),
  ('S08', '三民大昌店', '中區', '仕鈞店長', 50000),
